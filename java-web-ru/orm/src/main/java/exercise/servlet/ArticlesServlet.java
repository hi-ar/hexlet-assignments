...
public class ArticlesServlet extends HttpServlet {
    ...
    private void createArticle(HttpServletRequest request,
        ...
        // BEGIN
        // Допишите метод createArticle(), который создаёт новую статью и добавляет
        // её в базу данных. Для создания статьи используйте созданный ранее конструктор.
        int catId = Integer.parseInt(categoryId);
        Category category = new QCategory().id.equalTo(catId).findOne();
